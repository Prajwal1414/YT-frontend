export const categories = [
    "All", "JavaScript", "TypeScript", "Programming", "Weight lifting", "Bowling", "Cricket", "F1", "Football", "Comedy", "Coding", "Web3", "Construction", "Lifestyle", "Cooking", "Productivity", "Gaming", "Sidemen", "India's Got Latent", "Talent Shows", "Among Us", "PUBG"
...
export const videos = [
    ...
    },
    {
      ...
      channel: {
        ...
        id: "CalebCurry",
        profileUrl:
          "https://yt3.googleusercontent.com/ytc/AIdro_ndg1Q0vocIKu0U3Ks9SLkSCjZbGiZ2W1rhSsJoqZTgFK4=s176-c-k-c0x00ffffff-no-rj-mo",
      },
      views: 10340,
